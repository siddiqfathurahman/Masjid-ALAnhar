    ...
    <nav className="bg-green-900 p-4">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <ul className="hidden md:flex space-x-6 text-white">
          ...
          <li className="hover:text-slate-300 cursor-pointer">Profil</li>
          <li className="hover:text-slate-300 cursor-pointer">Program</li>
          <li className="relative cursor-pointer flex items-center" onClick={toggleDropdown}>
            ...
            {isDropdownOpen && (
              <ul className="absolute top-full left-0 bg-green-800 text-white w-40 rounded shadow-lg">
                <li className="hover:bg-slate-300 px-4 py-2">Ramah</li>
                <li className="hover:bg-slate-300 px-4 py-2">Takmir</li>
              </ul>
            )}
          </li>
        ...
        >
          ...
          <ul className="flex flex-col space-y-6 p-6 text-black">
            ...
            <li className="hover:text-green-800 cursor-pointer">Profil</li>
            <li className="hover:text-green-800 cursor-pointer">Program</li>
            <li className="cursor-pointer" onClick={toggleDropdown}>
              ...
              {isDropdownOpen && (
                <ul className="mt-2 space-y-2 pl-6 text-black">
                  <li className="hover:text-blue-300">Ramah</li>
                  <li className="hover:text-blue-300">Takmir</li>
                </ul>
              )}
            </li>
            <li className="hover:text-blue-300 cursor-pointer">Kontak</li>

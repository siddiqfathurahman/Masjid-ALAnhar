  ...
  const images = [
    {
      src: "/ramah4.jpeg",
      alt: "Masjid 1",
      berita: "Masjid Al-Anhar Mendaparkan juara 1 Kategori Lampion dan juara 2 Kostum pada takbir keliling yang diselenggarakan oleh PHBI MERGANGSAN",
      ...
      <Slider {...settings}>
        {images.map((image, index) => (
          ...
          >
            ...
            <div className="absolute md:bottom-24 bottom-8 md:left-7 left-4 pr-7 text-white text-sm sm:text-lg max-w-8xl md:text-xl lg:text-4xl font-bold">
              {image.berita}
            </div>

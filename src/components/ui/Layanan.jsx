const Layanan = () => {
  const layananData = [
    ...
    { id: 2, title: "Tempat ibadah nyaman dengan pendingin ruangan (AC)", image: "/ac.jpeg" },
      ...
      <div className="grid md:px-40 grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10 justify-items-center">
        {layananData.map((layanan) => (
          <div key={layanan.id} className="relative">
            <div className="md:w-[200px] md:h-[250px] w-[175px] h-[250px]  bg-gray-300 rounded-lg overflow-hidden">
              <img
                src={layanan.image}
                alt={layanan.title}

...
const data = [
  ...
  { date: 'Minggu, 2 Maret 2025', names: ['Rani', 'Bayu', 'Nayaka', 'Safa', 'Wanti', 'Queen', 'Lintang', 'deplin','Royhan', 'Rafa','Fatur', 'aga', 'Nada', 'Nita', 'Lovy'] },
  { date: 'Senin, 3 Maret 2025', names: ['Ilham (Kikik)', 'Dani', 'Tata', 'Ripat', 'Nayaka', 'Putra', 'Nita', 'rega', 'Nada', 'Queen', 'Lepy', 'Nayla', 'Kevin'] },
  { date: 'Selasa, 4 Maret 2025', names: ['Nayaka', 'Wanti', 'Kevin', 'Bayu', 'Evan', 'Pandya', 'Arvan', 'Lovy', 'Dea', 'Kiki', 'Rafa', 'Ripat', 'Selo', 'Nita'] },
  { date: 'Rabu, 5 Maret 2025', names: ['Putra', 'Lepy', 'Rani', 'Tata', 'deplin', 'Kiki', 'Dapol', 'Dea', 'Kevin', 'Ripat', 'Dodot', 'Evan', 'rega', 'Selo'] },
  { date: 'Kamis, 6 Maret 2025', names: ['Putra', 'Nayla', 'aga', 'Dani', 'Ilham (Kikik)', 'Lovy', 'Adit', 'Dea', 'Romy', 'Danis', 'Rafa', 'Dapol', 'Kevin', 'Ripat'] },
  { date: 'Jumat, 7 Maret 2025', names: ['Bayu', 'Rafa', 'Rafi', 'Rani', 'Kiki', 'Ilham (Kikik)', 'Bian', 'Lintang', 'Dani', 'Nada', 'Dapol', 'Danis', 'Nayla'] },
  ...
  { date: 'Minggu, 16 Maret 2025', names: ['Tata', 'Royhan', 'Lintang','Fatur','Lepy', 'Rafi', 'Danis', 'Putra', 'Arvan', 'rega', 'Bian', 'Rani', 'Abi', 'Ripat', 'Lovy'] },
  { date: 'Senin, 17 Maret 2025', names: [ 'Tata', 'Akmal', 'Danis', 'eka', 'Rafi', 'Safa', 'Selo', 'Adit', 'Kiki', 'Dodot', 'Pandya', 'Romy', 'Abi'] },
  ...
  { date: 'Selasa, 25 Maret 2025', names: ['Lovy','Dea', 'Akmal', 'Salsa', 'Abi', 'Dodot', 'Adit', 'Nayla', 'Wanti', 'Danis', 'Bian', 'Kevin', 'Briyan', 'Evan'] },

...
export const Artikel = [
  ...
  },
  {
    ...
    date: "Maret 2025",
    berita:
      "Setiap harinya Masjid Al-Anhar Menyediakan 200 porsi takjil untuk berbuka puasa. Selain itu, untuk menambah kenyamanan saat tadarus dan tarawih, juga disediakan 30 snack basah dan 50 snack kering",
    path: "/ramadhan1446h",
  },
  {
  ...
  },
  {
    ...
    date: "10 April 2025",
    berita:
      "Masjid Al-Anhar berhasil meraih juara 1 dalam kategori Lampion dan juara 2 untuk Kostum pada lomba Takbir Keliling yang diselenggarakan oleh PHBI Mergangsan. Prestasi ini menjadi kebanggaan tersendiri bagi jamaah dan pengurus masjid. Acara berlangsung meriah dengan partisipasi masyarakat yang antusias.",
  ...
  },
  {
    ...
    berita:
      "Masjid Al-Anhar mengadakan pengajian rutin berupa kajian Al-Quran untuk surat-surat pendek. Kegiatan ini diadakan setiap dua minggu sekali, tepatnya pada hari Rabu dan Senin setelah salat Isya. Pengajian ini bertujuan untuk memperdalam pemahaman Al-Quran dan mempererat ukhuwah Islamiyah.",
  ...
  },
  {
    ...
    berita:
      "Masjid Al-Anhar menggelar pengajian bulanan setiap Selasa pada pekan pertama bulan tersebut. Selain itu, ada juga pengajian khusus pada malam Jumat Kliwon yang diadakan setelah salat Isya. Acara ini dihadiri oleh jamaah dari berbagai kalangan, menambah semarak syiar Islam di lingkungan masjid.",
    path: "/pengajian-bulanan-tradisi-di-masjid-al-anhar",
  },
  {
    tittle: "Masjid Al-Anhar berhasil memperoleh 9 lembu dan 21 kambing",
    date: "17 Juni 2024",
    berita:
      "Masjid Al-Anhar sukses menyalurkan hewan qurban kepada 1.375 penerima manfaat yang tersebar di 8 RT dan 3 RW. Program ini menjadi wujud kepedulian sosial untuk masyarakat sekitar",
    path: "/masjid-al-anhar-berhasil-memperoleh-9-lembu-dan-21-kambing-dalam-qurban-1445h-2024",
  },
];
...
export const images = [
  ...
  },
  {
    ...
    alt: "Masjid 3",
    berita:
      "Pengajian bulanan diadakan setiap Selasa pada pekan pertama setiap bulan dan pada malam Jumat Kliwon setelah salat Isya",
    tanggal: "Kamis, 19 Desember 2024",
    path: "/pengajian-bulanan-tradisi-di-masjid-al-anhar",
  },
  {
    ...
    alt: "Masjid 4",
    berita:
      "Pada perayaan Idul Adha 1445 H, Masjid Al-Anhar berhasil memperoleh 9 ekor lembu dan 21 ekor kambing untuk disembelih sebagai bagian dari ibadah qurban.",
